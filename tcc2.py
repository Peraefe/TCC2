...
def compute_connectivity_metrics(G):
    ...
    return {
        ...
        "largest_cc_size": largest_scc_size,
...
if __name__ == "__main__":
    ...
    plot_metric(n_components, "Number of Strongly Connected Components vs Node Removal", "Number of Strongly Connected Components")
    plot_metric(largest_cc, "Largest Strongly Connected Component vs Node Removal", "Largest SCC Size")
